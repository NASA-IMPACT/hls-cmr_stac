...
landsat_band_info = {
    ...
    "Fmask": {"band": Band.create(name="Fmask"), "gsd": 30.0},
    "SZA": {"band": Band.create(name="SZA"), "gsd": 30.0},
    "SAA": {"band": Band.create(name="SAA"), "gsd": 30.0},
    "VZA": {"band": Band.create(name="VZA"), "gsd": 30.0},
    "VAA": {"band": Band.create(name="VAA"), "gsd": 30.0},
}
